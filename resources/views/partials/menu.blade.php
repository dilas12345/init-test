<aside class="main-sidebar sidebar-dark-primary elevation-4" style="min-height: 917px;">
    ...
    <a href="#" class="brand-link">
        <span class="brand-text font-weight-light">INITs</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <!-- @can('equipments_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.equipments.index") }}" class="nav-link {{ request()->is('admin/equipments') || request()->is('admin/equipments/*') ? 'active' : '' }}">
                            ...
                            <p>
                                <span>{{ trans('global.equipments.title') }}</span>
                            </p>
                        </a>
                    </li>
                @endcan -->
                @can('business_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.business.index") }}" class="nav-link {{ request()->is('admin/business') || request()->is('admin/business/*') ? 'active' : '' }}">
                            <i class="fas fa-cogs">

                            </i>
                            <p>
                                <span>{{ trans('global.business.title') }}</span>
                            </p>
                        </a>
                    </li>
                @endcan
